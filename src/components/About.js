  ...
  return (
    <div className={classes.root} id="about">
      <div className={classes.content}>
        <h2>About me</h2>
        <p>
          I followed a slightly unusual professional trajectory, that brought me from academic research in computational
          physics to software engineering, a field I am very passionate about.
        </p>
        <p>
          I currently work at{' '}
          ...
          (part of Okta) as a software engineer, where I am building at the intersection of large-scale distributed
          systems, security, identity and access management.
        </p>
        <p>
          ...
          , a dynamic startup company aiming to improve the world's aquaculture practices through the use of technology.
          This was an incredible experience and I got the opportunity to contribute and learn on many fronts. Prior to
          that, I started my journey in the industry at{' '}
